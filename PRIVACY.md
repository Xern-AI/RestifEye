# BreakTime Privacy Policy

**Everything stays on your machine.**

- BreakTime records activity data (active/idle/locked time slices, break outcomes, exercise history) solely to power your own dashboard, analytics, and advice.
- All data is stored locally in an SQLite database at `~/.local/share/breaktime/`. It never leaves your computer.
...
- BreakTime checks *whether* your microphone or camera is in use (via PipeWire) to avoid interrupting calls. It cannot and does not access audio or video content.
